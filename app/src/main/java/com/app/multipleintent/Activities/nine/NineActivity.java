package com.app.multipleintent.Activities.nine;
...
public class NineActivity extends AppCompatActivity {
    ...
    Button first, second, third, forth, fifth, sixth, seven, eight, ten;
    TextView textView;
    EditText editText;
    @Override
    ...
    private void passData() {
        ...
        second.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String message4 = editText.getText().toString();
                    ...
                    mediaPlayer2.start();
                    Intent intent = new Intent(NineActivity.this, SecondActivity.class);
                    intent.putExtra("message", message4);
                    Log.d("data",message4);
                    startActivity(intent);
               }
        ...
        third.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String message4 = editText.getText().toString();
                    mediaPlayer3.start();
                    Intent intent = new Intent(NineActivity.this, ThirdActivity.class);
                    intent.putExtra("message", message4);
                    Log.d("data",message4);
                    startActivity(intent);
                }
        ...
        forth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String message4 = editText.getText().toString();
                    ...
                    mediaPlayer4.start();
                    Intent intent = new Intent(NineActivity.this, ForthActivity.class);
                    intent.putExtra("message", message4);
                    Log.d("data",message4);
                    startActivity(intent);
               }
        ...
        fifth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String message4 = editText.getText().toString();
                    ...
                    mediaPlayer5.start();
                    Intent intent = new Intent(NineActivity.this, FifthActivity.class);
                    intent.putExtra("message", message4);
                    Log.d("data",message4);
                    startActivity(intent);
              }
        ...
        sixth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String message4 = editText.getText().toString();
                    ...
                    mediaPlayer6.start();
                    Intent intent = new Intent(NineActivity.this, SixActivity.class);
                    intent.putExtra("message", message4);
                    Log.d("data",message4);
                    startActivity(intent);
                }
        ...
        eight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String message4 = editText.getText().toString();
                    mediaPlayer8.start();
                    Intent intent = new Intent(NineActivity.this, EightActivity.class);
                    intent.putExtra("message", message4);
                    Log.d("data",message4);
                    startActivity(intent);
            }
        ...
        ten.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String message4 = editText.getText().toString();
                    mediaPlayer10.start();
                    Intent intent = new Intent(NineActivity.this, TenActivity.class);
                    intent.putExtra("message", message4);
                    Log.d("data",message4);
                    startActivity(intent);
                }
    ...
    private void iniUi() {
        ...
        //pass Data
       textView = (TextView)findViewById(R.id.data_TV9);
       editText = (EditText)findViewById(R.id.data_ET9);
